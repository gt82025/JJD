    ...
    function scrollMagicStart() {
        ...
        if ($mobile) {
            ...
            var scenrC2 = new ScrollMagic.Scene({
                ...
                }).setTween(handCakeArray[1], 1, { x: "0%", ease: Power2.easeOut, delay: 1 })
                .addTo($scrollMagic)
            ...
            var scenrC3 = new ScrollMagic.Scene({
                ...
                }).setTween(handCakeArray[2], 1, { x: "0%", ease: Power2.easeOut, delay: 1.5 })
                .addTo($scrollMagic)
            ...
            var scenrC4 = new ScrollMagic.Scene({
                ...
                }).setTween(handCakeArray[3], 1, { x: "0%", ease: Power2.easeOut, delay: 2 })
                .addTo($scrollMagic)
            ...
            var scenrC5 = new ScrollMagic.Scene({
                    triggerElement: 'section#People',
                    duration: 1300,
                    offset: $windowHeight * 1.6
                }).setTween(handCakeArray[4], 1, { y: "0%", ease: Power2.easeOut, delay: 2.5 })
                .addTo($scrollMagic)
