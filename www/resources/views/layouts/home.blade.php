...
<head>
    ...
    <link rel="stylesheet" href="css/_vendor/swiper/swiper.css">
    <link rel="stylesheet" type="text/css" href="css/_vendor/fullPage/fullpage.css" /> 
...
<header id="header">
        ...
        <div class="sideBar">
            ...
            <form action="{{url('cart')}}" method="POST">
                ...
                <div class="btnContainer">
                    ...
                    <button href="{{url('cart')}}" class="checkOut btnbox">開始結帳<span class="line1"> </span>
                        <span class="line2"> </span>
                    </button>
                </div>
            </form>
                ...
                <div class="registerMb ">
                    ...
                    <div class="share">
                        <a class="g_login" href="{{url('gRedirect')}}">
                            <img src="images/login_social_32.png" alt="">
                        </a>
                        <a href="{{url('fbRedirect')}}" class="fb_login">
                            <img src="images/login_social_30.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="forgetPW ">
    ...
    <script src="js/vendor/jquery-imagefill.min.js"></script>
    <!-- imagefill.js  http://johnpolacek.github.io/imagefill.js/ -->
    <!-- <script src="js/vendor/jquery.onepage-scroll-pluing.min.js"></script> -->
    <!-- <script src="js/vendor/jquery.onepage-scroll.min.js"></script> -->
    <!--One Page Scroll v1.3.1參考http://www.thepetedesign.com/demos/onepage_scroll_demo.html  -->
    <script src="js/vendor/swiper.min.js"></script>

    <!--fullpagejs 效果 https://github.com/alvarotrigo/fullPage.js/#fullpagejs -->
    <script type="text/javascript" src="js/vendor/fullpage.js"></script>
