    ...
    TWzipcode.prototype = {
        ...
        init: function () {
            ...
            $('<select/>')
                ...
                .attr('id',role.county.data('style') || ('undefined' !== typeof opts.css[0] ? opts.css[0] : ''))
                .appendTo(role.county.length ? role.county : container);

            $('<select/>')
                .attr('name', districtName)
                //.addClass(role.district.data('style') || ('undefined' !== typeof opts.css[1] ? opts.css[1] : ''))
                .attr('id',role.district.data('style') || ('undefined' !== typeof opts.css[1] ? opts.css[1] : ''))
            ...
            $('<input/>')
                ...
                .attr('id',role.county.data('style') || ('undefined' !== typeof opts.css[2] ? opts.css[2] : ''))
